...
class MobileNetV2(nn.Module):
    def __init__(self, num_classes=1000, output_stride=8, width_mult=1.0, inverted_residual_setting=None, round_nearest=8):
        ...
        if inverted_residual_setting is None:
            ...
            inverted_residual_setting = [
                # t, c, n, s
                [1, 8, 1, 1],   # c 从 16 减少到 8
                [6, 12, 2, 2],  # c 从 24 减少到 12
                [6, 16, 2, 2],  # c 从 32 减少到 16，n 从 3 减少到 2
                [6, 32, 3, 2],  # c 从 64 减少到 32，n 从 4 减少到 2
                [6, 48, 2, 1],  # c 从 96 减少到 48，n 从 3 减少到 2
                [6, 80, 2, 2],  # c 从 160 减少到 80，n 从 3 减少到 2
                [6, 162, 1, 1], # c 从 320 减少到 160
            ] # modified to adapt to 2M requirements
